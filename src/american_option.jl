###################################################################
# american_option.jl
# American Option Pricing Trough Stochastic Approximation
###################################################################
...
type PathsTree
	...
	function PathsTree(value,payofffun,level) 
		x = new() 
		x.value = value
		x.level = level
		x.childs = []
		x.counter = 0
		x.prob = 1
		x.exerciseFlag = false
		x.optionValue = payofffun(value)
		x
	end
	
	# For generic nodes
	function PathsTree(value, payofffun, level,father::PathsTree) 
		x = new() 
		x.value = value
		x.level = level
		x.childs = []
